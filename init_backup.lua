...
require('packer').startup(function(use)
  ...
  use 'sonobre/briofita_vim'
  use 'altercation/vim-colors-solarized'
  --use 'dracula/vim' --should I not use another theme called "Vim?"
  use 'jacoborus/tender.vim'
  use 'norogoth/nord-vim' -- my fork of the original nord theme
...
-- show the file path in statusline
